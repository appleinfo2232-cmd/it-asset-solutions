...
const SGE_CONTENT = {
  ...
  keyFeatures: [
    ...
    "NIST-Aligned Data Wiping", // CHANGED: Compliant -> Aligned
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6 mt-8">
                  {[
                    { title: "Data Sanitization", desc: "NIST 800-88 aligned wiping for all storage media.", icon: ShieldCheck }, // CHANGED: Compliant -> Aligned
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  a: "We are not currently certified. However, our internal processes are strictly aligned with recognized industry standards (R2v3, ISO 14001) to ensure responsible recycling and data security." // CHANGED: Compliant -> Aligned
                },
                {
