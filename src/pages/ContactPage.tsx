...
const ContactPage: React.FC = () => {
  ...
  const organizationSchema = {
    ...
    "description": "Enterprise ITAD partner and Public Electronics Recycling Center in Farmington Hills, MI.",
  ...
  // 2. LOCAL BUSINESS SCHEMA (For the Map Pack / Residents)
    ...
    "contactPoint": [
      {
        ...
        "name": "Corporate ITAD Sales" // Specific label
      },
      {
        "@type": "ContactPoint",
        "telephone": "+1-248-602-3832",
        ...
        "areaServed": "MI",
        "availableLanguage": "English",
        "name": "Public Recycling Drop-off" // Specific label
      }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        ...
        {/* DESCRIPTION: Clearly states both options */}
        <meta name="description" content="Contact us for a Corporate ITAD Quote or visit our Farmington Hills facility for Residential Electronics Recycling. Secure, compliant, and local." />
        ...
        <meta name="geo.position" content="42.498909;-83.367428" />
        <meta name="ICBM" content="42.498909, -83.367428" />
      ...
      <div className="pt-24">
        {/* The visual form component remains handled by Contact.tsx */}
        <Contact />
        <ContactLocation />
      </div>
    </>
