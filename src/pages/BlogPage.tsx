  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Expert insights on Enterprise ITAD, Data Destruction, and ESG compliance." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-20">
              <p className="text-xl text-slate-400 font-medium">No articles found matching criteria.</p>
