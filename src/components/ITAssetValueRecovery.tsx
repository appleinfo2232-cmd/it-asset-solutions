...
const ITAssetValueRecovery: React.FC = () => {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: 'Before any remarketing can occur, all devices are sanitized using methods aligned with NIST 800-88 standards. This protects your sensitive data while preserving the hardware\'s value for resale.',
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Any asset that does not have sufficient resale value is seamlessly moved into our Responsible Recycling stream. We ensure that every component is handled sustainably, and you receive full documentation for both remarketed and recycled assets.',
      icon: RefreshCw
    },
    {
