...
const WhyChooseUs: React.FC = () => {
  ...
  const advantages = [
    ...
    },
    {
      ...
      description: 'Navigating the complex web of data privacy and environmental regulations is our expertise. We provide a fully aligned process and the documentation to prove it, protecting your business from legal and financial penalties.',
      color: 'text-java',
