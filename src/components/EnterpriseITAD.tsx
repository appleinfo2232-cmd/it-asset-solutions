...
const EnterpriseITAD: React.FC = () => {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: 'We perform verifiable data erasure and destruction that meets rigorous NIST 800-88 standards, providing Certificates of Destruction for your audit trail.',
    ...
    {
      icon: Recycle,
      title: 'Compliant & Sustainable Recycling',
      description: 'End-of-life assets are responsibly recycled in accordance with all federal and state environmental regulations, adhering to a strict zero-landfill policy for hazardous e-waste.',
  ...
  const faqs = [
    {
      ...
      answer: 'IT Asset Disposition (ITAD) is the business practice of securely and responsibly disposing of obsolete or unwanted IT equipment. A comprehensive ITAD program includes secure logistics, data destruction, remarketing for value recovery, and compliant electronics recycling.',
      icon: Shield
    },
    {
      question: 'Why is a managed ITAD program important for my business?',
      answer: 'A managed ITAD program is crucial for mitigating risk. It protects you from data breaches, ensures you comply with environmental and data privacy regulations (like HIPAA or GLBA), and maximizes the financial return on your retired assets, turning a potential liability into a value-add for your company.',
      icon: Award
    },
    {
  ...
  const differentiators = [
    ...
    {
      icon: Award,
      title: 'Proven Compliance',
      description: 'We\'ve built our reputation on providing a process that is not only compliant but also completely transparent.',
      color: 'text-java',
          ...
          >
            <div className="bg-white/90 backdrop-blur-xl border border-white/30 rounded-3xl shadow-2xl p-8 md:p-12">
              <p className="text-xl md:text-2xl text-gray-700 leading-relaxed mb-8">
                Your technology fuels your business growth. But when it's time to retire those assets, the process can become a complex web of security risks, logistical nightmares, and compliance traps. Without a strategic partner, you're not just losing value—you're exposed to liability.
              </p>
