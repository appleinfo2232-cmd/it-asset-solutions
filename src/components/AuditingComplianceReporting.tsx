...
const AuditingComplianceReporting: React.FC = () => {
  ...
  const reportTypes = [
    ...
    },
    {
      ...
      description: 'Legal certification that data destruction was performed per NIST 800-88 guidelines, supporting your HIPAA, GLBA, and SOX documentation.',
    ...
    },
    {
      ...
      description: 'Confirms that non-reusable assets were processed in accordance with EPA regulations and our zero-landfill policy for hazardous e-waste.',
  ...
  const complianceFrameworks = [
    ...
    },
    {
      ...
      details: 'Secure disposal of financial services IT equipment'
    },
    {
      icon: FileCheck,
      title: 'SOX',
    ...
    },
    {
      ...
      details: 'Strict adherence to federal guidelines for hazardous materials'
    }
  ];
  ...
  const auditingFeatures = [
    ...
    {
      icon: Eye, // Note: Import Eye if missing, or use SearchCheck
    ...
    },
    {
      ...
      description: 'Legally robust certificates and reports retained for 7 years to satisfy any internal or external audit',
      color: 'text-java',
  ...
  const targetAudience = [
    {
      ...
      description: 'Need audit-ready documentation for regulatory requirements',
    ...
    },
    {
      ...
      solution: 'NIST 800-88 aligned destruction with complete audit trails'
    },
    {
      icon: FileBarChart,
  ...
  const faqs = [
    ...
    {
      question: 'Are your processes aligned with industry regulations like HIPAA and GLBA?',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-curious-blue font-bold text-lg">Auditing & Reporting</span>
          ...
          >
            <div className="bg-white/90 backdrop-blur-xl border border-white/30 rounded-3xl shadow-2xl p-8 md:p-12">
              <p className="text-xl md:text-2xl text-gray-700 leading-relaxed mb-8">
                When it comes to retiring IT assets, trust isn't built on promises—it's built on proof. In regulated industries and high-stakes environments, you need more than a handshake. You need serialized tracking, certified destruction, and audit-ready documentation that stands up to scrutiny.
              </p>
              ...
              >
                <p className="text-xl md:text-2xl font-bold leading-relaxed text-gray-900">
                  That's exactly what our <span className="text-transparent bg-clip-text bg-gradient-to-r from-curious-blue to-java">Auditing & Reporting</span> service delivers: Complete visibility, unshakeable accountability, and legally defensible documentation for every single asset that passes through our facility.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        >
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="text-tradewind font-semibold">Regulatory Alignment</span>
            </motion.div>
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-12">
              Our processes and documentation align with the requirements of major regulatory frameworks.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-curious-blue via-mountain-meadow to-java rounded-3xl p-12 text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
                Contact us to learn how our auditing and reporting gives you the documentation and peace of mind you need.
              </p>
