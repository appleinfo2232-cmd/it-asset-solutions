...
import { ArrowRight, Zap, Sparkles, Handshake } from 'lucide-react';
    ...
    <section className="relative py-20 bg-gradient-to-br from-gray-50 via-white to-jagged-ice overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <Handshake className="w-5 h-5 text-curious-blue" />
            <span className="text-curious-blue font-semibold">Your Journey Starts Here</span>
          </motion.div>
          ...
          >
            Whether you're looking to securely dispose of old equipment, recover value, or simply learn more, our team is ready to assist you.
          </motion.p>

          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <motion.button
              onClick={() => scrollToSection('contact', '/')}
              className="bg-gradient-to-r from-curious-blue to-java text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl hover:from-java hover:to-mountain-meadow transition-all duration-300 flex items-center justify-center space-x-3"
            ...
            <Link to="/contact">
              <motion.button
                className="border-2 border-curious-blue text-curious-blue px-8 py-4 rounded-full font-bold text-lg shadow-xl hover:bg-curious-blue hover:text-white transition-all duration-300 flex items-center justify-center space-x-3"
                initial={{ opacity: 0, y: 20 }}
                animate={inView ? { opacity: 1, y: 0 } : {}}
