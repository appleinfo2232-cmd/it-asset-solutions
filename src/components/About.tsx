...
const About: React.FC = () => {
  ...
  const services = [
    {
      ...
      description: "Your data's security is non-negotiable. Our process is designed for zero-risk data elimination, adhering to rigorous NIST and DoD standards. We provide a full audit trail and a Certificate of Destruction for every asset, giving you the proof you need to be fully compliant.",
      color: 'from-curious-blue to-java',
      iconColor: 'text-curious-blue',
      bgGradient: 'from-curious-blue/10 to-java/10',
      features: ['NIST 800-88 Standards', 'DoD Compliance', 'Certificate of Destruction', 'Full Audit Trail']
    },
    {
      icon: TrendingUp,
    ...
    {
      icon: Recycle,
      title: 'Sustainable & Compliant Recycling',
      description: 'For assets at the true end of their life, we ensure they are handled responsibly. We partner with fully vetted, compliant recycling facilities to guarantee adherence to all federal and Michigan state environmental regulations, with a strict zero-landfill policy for hazardous materials.',
      color: 'from-tradewind to-bermuda',
      iconColor: 'text-tradewind',
      bgGradient: 'from-tradewind/10 to-bermuda/10',
      features: ['Zero Landfill Policy', 'Vetted Partners', 'Environmental Compliance', 'Hazardous Material Handling']
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'We use a multi-step process that adheres to NIST 800-88 and DoD standards. We provide a Certificate of Destruction for every single serialized asset we process, giving you a verifiable audit trail and complete peace of mind.',
      icon: Shield
    },
    {
  ...
  return (
    <section id="about" className="relative py-32 bg-gradient-to-br from-slate-50 via-blue-50/60 to-emerald-50/40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Commitment to Compliance & Security Section */}
        <motion.div
          ref={complianceRef}
          className="mb-24"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              transition={{ duration: 0.8, delay: 0.4 }}
            >
              In the ITAD industry, trust is everything. While we are actively pursuing formal certifications like R2v3 and NAID AAA as a top business priority, our operational processes are already built from the ground up to meet and exceed these stringent standards.
            </motion.p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              >
                ...
                <div className="flex items-center space-x-3 text-base text-gray-600 bg-white rounded-lg p-4 shadow-md relative z-10">
                  ...
                  <span className="font-medium">NIST SP 800-88 Rev. 1 Compliant</span>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed mb-6 text-lg relative z-10">
                  We operate in full compliance with all local, state, and federal EPA regulations for e-waste. We maintain a zero-landfill policy for all electronic equipment, ensuring that your assets are handled in the most environmentally sustainable way possible.
                </p>
                <div className="flex items-center space-x-3 text-base text-gray-600 bg-white rounded-lg p-4 shadow-md relative z-10">
                  <CheckCircle className="w-5 h-5 text-mountain-meadow flex-shrink-0" />
                  <span className="font-medium">EPA Regulations Compliant</span>
                </div>
              </motion.div>
