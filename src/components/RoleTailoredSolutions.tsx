...
const RoleTailoredSolutions: React.FC = () => {
  ...
  const roleSolutions = [
    ...
    },
    {
      ...
      description: 'We deliver peace of mind through an ironclad, auditable process. With guaranteed data destruction compliant with NIST 800-88 and comprehensive reporting, we provide the documentation you need to satisfy the most stringent regulatory requirements, including HIPAA, GLBA, and SOX.',
      benefits: ['Ironclad audit trail', 'NIST 800-88 compliance', 'Comprehensive reporting', 'Regulatory satisfaction'],
