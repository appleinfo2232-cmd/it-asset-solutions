...
const SecureProcess: React.FC = () => {
  ...
  const processSteps = [
    {
      ...
      // UPDATE: Added Remote Workforce Retrieval
      description: 'We handle secure logistics for data centers, corporate offices, and remote workforce retrieval. From GPS-tracked fleets to secure box-and-ship programs, we maintain chain of custody from the start.',
    ...
    {
      icon: Shield,
      title: 'Processing & Guaranteed Data Destruction',
      description: 'At our secure facility, every asset is audited. All data-bearing devices undergo a rigorous data destruction process compliant with NIST 800-88 standards, ensuring your sensitive information is permanently eliminated.',
    ...
    {
      icon: TrendingUp,
      title: 'Value Recovery & ESG Recycling',
      // UPDATE: Added ESG Reporting
      description: 'Assets with remaining value are expertly remarketed to maximize ROI. End-of-life equipment is recycled via EPA R2 certified partners, providing you with full ESG reporting and Zero-Landfill assurance.',
    ...
    {
      icon: FileText,
      title: 'Detailed Reporting & Certification',
      description: 'You receive a comprehensive reporting package, including a full inventory audit and official Certificates of Destruction and Recycling. This provides a clear, auditable trail for your records and compliance needs.',
  ...
  const processStats = [
    ...
    { icon: ShieldCheck, label: 'Security Level', value: 'Military', color: 'text-java' },
    { icon: Award, label: 'Compliance Rate', value: '100%', color: 'text-tradewind' }
  ];
      ...
      <div className="absolute inset-0">
        {[...Array(8)].map((_, i) => (
          <motion.div
            ...
            transition={{ duration: 4, delay: Math.random() * 2, repeat: Infinity, repeatType: "loop" }}
          />
        ))}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-white font-medium">Transparent Process</span>
          </motion.div>

          <h2 className="text-5xl md:text-6xl font-bold text-white mb-6 relative">
            Our Secure and
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-mountain-meadow via-curious-blue to-fountain-blue"> Transparent Process</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            In our experience, a clear and documented process is the foundation of trust. We demystify ITAD with a straightforward approach that guarantees security and accountability at every step.
          </p>
          ...
          <div className="bg-gradient-to-r from-curious-blue via-mountain-meadow to-fountain-blue rounded-3xl p-12 text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              >
                ...
                <span className="font-semibold">Foundation of Trust</span>
              </motion.div>

              <h3 className="text-3xl md:text-4xl font-bold mb-6">
                Experience Our Transparent Process
              </h3>
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                See how our clear, documented approach provides security and accountability at every step of your ITAD journey.
              </p>
