...
const SecureDataDestruction: React.FC = () => {
  ...
  const destructionMethods = [
    {
      icon: Lock,
      title: 'NIST 800-88 Compliant Data Erasure',
      ...
      features: ['Software-based overwriting', 'Hardware functionality preserved', 'Ideal for value recovery', 'NIST 800-88 compliant'],
  ...
  const faqs = [
    {
      ...
      answer: 'Our data destruction processes are designed in accordance with the rigorous standards set by the NIST 800-88 "Guidelines for Media Sanitization" and the DoD 5220.22-M specification, ensuring your data is handled to meet strict compliance requirements.',
      icon: Shield
    },
    {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: 'NIST 800-88 compliant erasure or physical destruction'
    },
    {
      icon: FileText,
      title: 'Certification',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="bg-white/90 backdrop-blur-xl border border-white/30 rounded-3xl shadow-2xl p-12 md:p-16">
            <p className="text-xl text-gray-700 leading-relaxed mb-8 text-center">
              We treat data destruction as the most critical step in the ITAD lifecycle. Our promise is simple: to provide a secure, compliant, and verifiable process that protects your business from all data-related risks. Our services are designed to help you meet your compliance obligations under regulations like HIPAA, GLBA, and SOX.
            </p>
        ...
        >
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Compliance and Verifiable Proof
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-12">
              Our data destruction processes are designed in accordance with the rigorous standards set by the NIST 800-88 "Guidelines for Media Sanitization" and the DoD 5220.22-M specification. Upon completion, we provide you with a formal Certificate of Destruction that details the services performed, includes serialized asset information, and serves as your legal proof of compliance.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-curious-blue via-mountain-meadow to-java rounded-3xl p-12 text-white relative overflow-hidden">
            <div className="relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl font-bold mb-6">
                Protect your legacy and ensure complete compliance.
              </h3>
