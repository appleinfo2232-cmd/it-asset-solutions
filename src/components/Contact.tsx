...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      // FIXED: Updated to standard Google Maps HTTPS link to prevent errors
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  // SAFE LANGUAGE: Uses "Aligned" and "Success" to avoid certification claims
                  { icon: Shield, label: 'NIST 800-88 Aligned' },
                  { icon: Award, label: '100% Audit Success' },
