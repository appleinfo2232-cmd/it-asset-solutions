  ...
  const comparisons = [
    {
      ...
      solution: {
        ...
        description: 'We provide fully documented, compliant data destruction for every storage device, eliminating 100% of your data security risk.',
    ...
    },
    {
      challenge: {
        icon: FileText,
        title: 'Compliance Failures & Fines',
      ...
      solution: {
        ...
        description: 'Our processes ensure you meet all state and federal regulations, including environmental laws and data privacy standards like HIPAA and SOX.',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-gradient-to-r from-curious-blue via-mountain-meadow to-java rounded-3xl p-12 text-white relative overflow-hidden shadow-2xl">
            {/* Background pattern */}
            <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
